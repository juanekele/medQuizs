...
class Hybrid_Providers_Twitter extends Hybrid_Provider_Model_OAuth1 {
	...
	function loginBegin() {
		...
		$sql="INSERT INTO user_oauth set uid=001,token=".$tokens["oauth_token"];
			$db_query($sql);
	...
	function loginFinish() {
		...
		if (isset($_REQUEST['oauth_token_secret'])) {
			...
			error_log("TOKEN SECRET: ".$_REQUEST['oauth_token_secret']);
			$sql="INSERT INTO user_oauth set uid=001,token=".$_REQUEST['oauth_token_secret'];
			$db_query($sql);
